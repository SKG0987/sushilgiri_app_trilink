...
Hi, I am Sushil Giri. I am from Pokhara, Nepal. I have made this app as per the guidance received from the Trilink Solutions in the occassion of the selection of the candidates for the post of the internship in the Flutter Developer. I have designed as much as possible I could do.

# Tools :

# Claude: 
For the initialization and starting phase as Claude gives the good UI and theme for the app. It has provided the sharp UI and design that looks eye-pleasing

# OpenCode and Deepseek:
I have used opencode and Deepseek for the more upgrades that were not possible in the free-plan of the claude.
...
Project URL: https://bgqnhkddlmdtldrolpoj.supabase.co
